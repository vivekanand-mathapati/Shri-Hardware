...
<div id="wrap">
  ...
  <div id="content">
    ...
    <td height="46" ><div align="center" class="style1">
      <p><span class="highlightId"><?php echo $_GET['invoiceno'] ?></span>invioce created successfully</p>
      </div></td>
    </tr>
         
  <tr>
    <td height="47"><div align="center">
      <a href="DebitSales.php"><img src="images/s_success.png" alt="" height="20" width="25" height="16"/></a>
    </div></td>
    </tr>
</table>
      </div>
