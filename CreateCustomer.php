...
<?php
include("connect.php");
$my_result = mysql_query("select max(countcid) from CustomerDetail");
$countcid =  mysql_result($my_result,0);
$countcid+=1;
?>
<body>
<form id="form1" name="form1" method="post" action="CustomerCreationSuccess.php?customerCountId=<?php echo $countcid ?>" onsubmit="return validateCreateCustomer(this)">
<div id="wrap">
  <div id="top">
  ...
  <div id="content">
    ...
    <td height="41" colspan="7" ><div align="center" class="style1">
      <p>Create Customer </p>
         ...
         <tr>
           ...
           <td><input name="custid" type="text" size="10" value="cust000<?php echo $countcid ?>" readonly="true"/></td>
           <td>&nbsp;</td>
           <td>&nbsp;</td>
         </tr>
         <tr>
    ...
    <td><input name="name" type="text" size="20" onblur="return alphavalidate(this)"/></td>
    <td width="20">&nbsp;</td>
    <td width="176">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input name="email" type="text" size="20" onblur="return emailvalidate(this)"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') 
{
   ...
   $my_result = mysql_query("insert into CustomerDetail values('$id','$name','$address','$phone','$email','$countcid')");
   
	
   
   if($my_result)
{
	header("location: CustomerCreationSuccess.php?customerId=".$id);
} else {
