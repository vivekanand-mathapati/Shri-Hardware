    ...
    <div id="right">
	  ...
	  if($my_result){
	   ...
	   <td height="46" ><div align="center" class="style1">
        <p>Customer <span class="highlightId"><?php echo $id ?></span> Created Successfully</p>
		</div></td>
    </tr>
         
  <tr>
    <td height="47"><div align="center">
      <a href="CreateCustomer.php"><img src="images/b_usrcheck.png" alt="" height="30" width="35" height="16"/></a>
		<?php
		}
	  else{
	   ?>
	   <td height="46" ><div align="center" class="style1">
	   <p>Vendor <span class="highlightId"><?php echo $id ?></span> Creation Unsuccessful</p>
	   </div></td>
    </tr>
         
  <tr>
    <td height="47"><div align="center">
      <a href="CreateCustomer.php"><img src="images/b_usrdrop.png" alt="" height="30" width="35" height="16"/></a>
	   <?php
	  }
	   ?>
